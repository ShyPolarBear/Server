...
public class RankingService {
    ...
    public RankingResponse findMyRanking(Long userId) {
        Ranking ranking = rankingRepository.findUserRanking(userId).orElseThrow(() -> new RankingException(ExceptionStatus.NOT_FOUND_RANKING));
        return RankingResponse.of(ranking);
    }
